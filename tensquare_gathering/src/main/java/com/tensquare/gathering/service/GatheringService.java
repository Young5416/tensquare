...
public class GatheringService {
  ...
  @Autowired private GatheringDao gatheringDao;
  ...
  private Specification<Gathering> createSpecification(Map searchMap) {
    ...
    return new Specification<Gathering>() {
      ...
      public Predicate toPredicate(
          Root<Gathering> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        if (searchMap.get("city") != null && !"".equals(searchMap.get("city"))) {
          predicateList.add(
              cb.like(
                  root.get("city").as(String.class), "%" + (String) searchMap.get("city") + "%"));
        }
